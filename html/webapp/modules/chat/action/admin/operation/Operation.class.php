 ...
 * @access      public
 */
class Chat_Action_Admin_Operation extends Action
{
	...
	function execute()
	{
		switch ($this->mode) {
    		case "move":
				...
				$result = $this->db->updateExecute("chat", $params, $where_params, false);
				if($result === false) {
					return "false";
				}
				$result = $this->db->updateExecute("chat_contents", $params, $where_params, false);
				if($result === false) {
					return "false";
				}
				$result = $this->db->updateExecute("chat_login", $params, $where_params, false);
				if($result === false) {
					return "false";
				}
				break;
